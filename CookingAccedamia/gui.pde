...
public void changeoventemp(GCustomSlider source, GEvent event) { //_CODE_:oventemp:807665:
  ovenstemperaure += oventemp.getValueF();
} //_CODE_:oventemp:807665:
...
public void createGUI(){
  ...
  dropLists.add(new GDropList(Receipe, 29, 64, 90, 80, 3, 10));
  ...
  oventemp = new GCustomSlider(Receipe, 99, 93, 100, 40, "grey_blue");
  oventemp.setLimits(50.0, 10.0, 100.0);
  oventemp.setNumberFormat(G4P.DECIMAL, 2);
  oventemp.setOpaque(false);
  oventemp.addEventHandler(this, "changeoventemp");
  Ovenslabel = new GLabel(Receipe, 13, 93, 80, 37);
  Ovenslabel.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  Ovenslabel.setText("Oven");
  Ovenslabel.setOpaque(false);
